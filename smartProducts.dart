...
const String _baseURL = 'watchapp.atwebpages.com';
...
void updateSmartProducts(Function(bool success) update) async {
  try {
    final url = Uri.http(_baseURL, 'smartProducts.php');
...
class ShowSmartProducts extends StatelessWidget {
  const ShowSmartProducts({Key? key}) : super(key: key);
