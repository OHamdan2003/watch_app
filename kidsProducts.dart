...
void updateKidProducts(Function(bool success) update) async {
  try {
    final url = Uri.http(_baseURL, 'kidProducts.php');
...
class ShowkidProducts extends StatelessWidget {
  const ShowkidProducts({Key? key}) : super(key: key);
